...
from models.park_speech import ANN, ShallowANN
...
trainer = TUTrainer(accelerator="gpu", max_epochs=64, enable_progress_bar=True, log_every_n_steps=10)
datamodule = ParkSpeechDataModule(root=root, num_workers=7, test_ids_path=f'./data/test_set_participants.txt', dev_ids_path="./data/dev_set_participants.txt")

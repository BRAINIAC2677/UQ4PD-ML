...
def main_hpt(n_trials: int, log_file: str):
    ...
    with open(log_file, "a") as f:
        f.write(f"Dataset: finger_tapping | Method: mcdropout\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Hyperparameter tuning for MC-Dropout on FINGER TAPPING dataset")

import optuna
import argparse
from dec.train_chestx import main
...
def objective(trial):
    ...
    return val_results[0]["val/cls/F1"]  # Adjust based on your actual evaluation metric
...
def main_hpt(n_trials: int, log_file: str):
    ...
    with open(log_file, "a") as f:
        f.write(f"Dataset: chestx | Method: dec\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Hyperparameter tuning for dec on chestx dataset")

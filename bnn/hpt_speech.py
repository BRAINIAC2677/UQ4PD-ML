import optuna
import argparse
from bnn.train_speech import main
...
def main_hpt(n_trials: int, log_file: str):
    ...
    with open(log_file, "a") as f:
        f.write(f"Dataset: speech | Method: bnn\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Hyperparameter tuning for bnn on speech dataset")
    parser.add_argument("--n_trials", type=int, default=100, help="Number of trials for Optuna") 
    parser.add_argument("--log_file", type=str, default="hpt_speech.log", help="Log file to save results")

...
from torchmetrics import Accuracy, MetricCollection, F1Score, AUROC, AveragePrecision, Specificity, Recall
...
class ClassificationRoutine(LightningModule):
    ...
    def _init_metrics(self) -> None:
        ...
        metrics_dict = {
            ...
            "cls/F1": F1Score(task=task, num_classes=self.num_classes),
            "cls/Sensitivity": Recall(task=task, num_classes=self.num_classes),
            "cls/Specificity": Specificity(task=task, num_classes=self.num_classes),
        ...
        groups = [
            ...
            ["sc/AURC", "sc/AUGRC", "sc/Risk@80Cov"],
        ]
